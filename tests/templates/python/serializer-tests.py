...
import pytest
from PythonEncoder import (JsonEncoder, JsonEncoderOptions, to_camel_case,
                           to_snake_case)
...
"""
{
    ...
    "timedeltaValue": "1.02:03:04.0050060",
    "enumValue": "A",
    "nestedValue": {
...
"""
{
    ...
    "floatValue": 1.1,
    "strValue": "1",
    "datetimeValue": "2020-01-02T03:04:05.6789010Z",
    "timedeltaValue": "1.02:03:04.0050060",
    "enumValue": "A",
    "nestedValue": {
        "uuidValue": "9842d4b6-0b89-4b56-ad0f-acb5b8be8112"
...
def can_decode_primitive_test(json_string: str, cls: Type, expected: Any):
